...
const sectionBaseClass = "flex flex-col items-center gap-[22px] px-5 py-8 desktop:grid desktop:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] desktop:gap-14 desktop:px-[160px] desktop:py-16";
...
const IntroSection = ({
  ...
  >
    ...
    >
      ...
      <span className="whitespace-nowrap text-lg font-bold text-theme-accent">#{meta}</span>
